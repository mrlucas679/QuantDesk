...
public sealed class ExitEngineTests
{
    ...
    public void ExitsOnInvalidatedThesisBeforeOtherRules()
    {
        ...
        ExitEvaluation result = new ExitEngine().Evaluate(plan, 0, 1, new Usd(0), false, false);
    ...
    public void ExitsAtMaximumAdverseLoss()
    {
        ...
        ExitEvaluation result = new ExitEngine().Evaluate(plan, 0, 1, new Usd(-10), true, true);
